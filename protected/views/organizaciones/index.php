...
<?php $this->headers = ' Organizaciones'; ?>
...
<a class="btn btn-success btn-large" href="index.php?r=Organizaciones/reporte"> 
	<i class="glyphicon glyphicon-print icon-white", title="Impresión de datos.", data-toggle="tooltip"></i>
</a>


<div  align="right">
        <a class="btn btn-info btn-large" href="index.php?r=Organizaciones/create"> 
...
<?php 
	...
	'columns'=>array(
		array(
			'name'=>'organizacion',
			'type'=>'raw',
					'value'=>'CHtml::link(CHtml::encode($data->organizacion), array("view&id=$data->id"))',
		),
				array(
		'class'=>'CButtonColumn',
