...
<a class="btn btn-success btn-large" href="index.php?r=Servicios/reporte"> 
	<i class="glyphicon glyphicon-print icon-white", title="Impresión de datos.", data-toggle="tooltip"></i>
</a>


<div  align="right">
        <a class="btn btn-info btn-large" href="index.php?r=Servicios/create"> 
...
<?php 
	...
	'columns'=>array(
		array(
			'name'=>'servicio',
			'type'=>'raw',
			'value'=>'CHtml::link(CHtml::encode($data->servicio), array("view&id=$data->id"))',
		),
				array(
		'class'=>'CButtonColumn',
