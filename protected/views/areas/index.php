...
<a class="btn btn-success btn-large" href="index.php?r=Areas/reporte"> 
	<i class="glyphicon glyphicon-print icon-white", title="Impresión de datos.", data-toggle="tooltip"></i>
</a>


<div  align="right">
        <a class="btn btn-info btn-large" href="index.php?r=Areas/create"> 
...
<?php 
	...
	'columns'=>array(
		array(
			'name'=>'dependencia_id',
			'type'=>'raw',
					'value'=>'CHtml::link(CHtml::encode($data->Dependencias->dependencia), array("view&id=$data->id"))',
			),
					array(
			'name'=>'servicio_id',
			'type'=>'raw',
