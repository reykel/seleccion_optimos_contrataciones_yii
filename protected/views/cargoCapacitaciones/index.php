...
$('.search-form form').submit(function(){
	$('#cargo-capacitaciones-grid').yiiGridView('update', {
		data: $(this).serialize()
	});
	return false;
});
...
<?php $this->headers = ' Cargo capacitaciones'; ?>
...
<a class="btn btn-success btn-large" href="index.php?r=CargoCapacitaciones/reporte"> 
	<i class="glyphicon glyphicon-print icon-white", title="Impresión de datos.", data-toggle="tooltip"></i>
</a>


<div  align="right">
        <a class="btn btn-info btn-large" href="index.php?r=CargoCapacitaciones/create"> 
...
<?php 
	...
	'columns'=>array(
		array(
			...
			'type'=>'raw',
			'value'=>'$data->EscalasCapacitaciones->escala_capacitacion',
		),
		array(
			'name'=>'cargo_id',
			'type'=>'raw',
