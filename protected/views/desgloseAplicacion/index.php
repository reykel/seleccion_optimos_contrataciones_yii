...
$('.search-form form').submit(function(){
	$('#desglose-aplicacion-grid').yiiGridView('update', {
		data: $(this).serialize()
	});
	return false;
});
...
<?php $this->headers = ' Desglose aplicacion'; ?>
...
<a class="btn btn-success btn-large" href="index.php?r=DesgloseAplicacion/reporte"> 
	<i class="glyphicon glyphicon-print icon-white", title="Impresión de datos.", data-toggle="tooltip"></i>
</a>


<div  align="right">
        <a class="btn btn-info btn-large" href="index.php?r=DesgloseAplicacion/create"> 
...
<?php 
	...
	'columns'=>array(
		array(
			'name'=>'aplicacion_id',
			'type'=>'raw',
					'value'=>'CHtml::link(CHtml::encode($data->Aplicacions->aplicacion), array("view&id=$data->id"))',
			),
					array(
			'name'=>'item_id',
			'type'=>'raw',
