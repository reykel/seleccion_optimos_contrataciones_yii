...
<?php $this->headers = ' Cargo ocupaciones'; ?>
...
<a class="btn btn-success btn-large" href="index.php?r=CargoOcupaciones/reporte"> 
	<i class="glyphicon glyphicon-print icon-white", title="Impresión de datos.", data-toggle="tooltip"></i>
</a>


<div  align="right">
        <a class="btn btn-info btn-large" href="index.php?r=CargoOcupaciones/create"> 
...
<?php 
	...
	'columns'=>array(
		array(
			...
			'type'=>'raw',
			'value'=>'$data->EscalasOcupaciones->escala_ocupacion',
		),
		array(
			'name'=>'cargo_id',
			'type'=>'raw',
