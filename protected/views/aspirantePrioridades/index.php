...
<?php $this->headers = ' Prioridades de '.Aspirantes::get_aspirante($_aspirante_id); ?>

<div  align="right">
        <?php echo '<a class="btn btn-info btn-large" href="index.php?r=aspirantePrioridades/create&_aspirante_id='.$_aspirante_id.'">'; ?> 
