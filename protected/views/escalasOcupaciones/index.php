...
$('.search-form form').submit(function(){
	$('#escalas-ocupaciones-grid').yiiGridView('update', {
		data: $(this).serialize()
	});
	return false;
});
...
<?php $this->headers = ' Escalas ocupaciones'; ?>
...
<a class="btn btn-success btn-large" href="index.php?r=EscalasOcupaciones/reporte"> 
	<i class="glyphicon glyphicon-print icon-white", title="Impresión de datos.", data-toggle="tooltip"></i>
</a>


<div  align="right">
        <a class="btn btn-info btn-large" href="index.php?r=EscalasOcupaciones/create"> 
...
<?php 
	...
	'id'=>'escalas-ocupaciones-grid',
	'dataProvider'=>$model->search(),
	'ajaxUpdate' => false,
	'columns'=>array(
		array(
			'name'=>'escala_ocupacion',
			'type'=>'raw',
					'value'=>'CHtml::link(CHtml::encode($data->escala_ocupacion), array("view&id=$data->id"))',
		),
				array(
		'class'=>'CButtonColumn',
