...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<?php echo $form->errorSummary($model); ?>
		...
		<?php echo $form->label($model,'escala_ocupacion', array('class'=>'control-label')); ?>
			<?php echo $form->textField($model,'escala_ocupacion', array('class'=>'form-control', 'style'=>'font-size:11px;')); ?>
			<?php echo $form->error($model,'escala_ocupacion'); ?>
