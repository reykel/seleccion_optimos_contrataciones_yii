...
<?php 
	...
	'id'=>'aspirantes-grid',
	'dataProvider'=>$model->search_descartes(),
	'ajaxUpdate' => false,
	'columns'=>array(
		array(
            'header'=>'',
	...
	array(
		'class'=>'CButtonColumn',
		'htmlOptions'=>array('style'=>('width:215px;')),
		'template'=>'{update}{delete}{imagenes}{retorno}',
            'buttons' => array(
	            'update' => array(
	            ...
	            'retorno' => array(
                	...
                	'url'=>'Yii::app()->createUrl("aspirantes/reingreso",array("id"=>$data->id))',
