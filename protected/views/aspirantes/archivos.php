...
<div  align="right">
        <?php echo '<a class="btn btn-info btn-large" href="index.php?r=aspirantes/upload&id='.$_aspirante_id.'">'; ?>
...
<?php 
	...
	'columns'=>array(
		...
		array(
			'name'=>'archivo',
			'type'=>'raw',
			'value'=>'CHtml::link(CHtml::encode($data->archivo), array("aspirantes/download&id=$data->id"))',
		),
		array(
			'header'=>' ... ',
			'class'=>'CButtonColumn',
...
<br>
<div  align="left">
        <?php echo "<a class='btn btn-danger btn-large' href='index.php?r=aspirantes/index&id=".$_aspirante_id."'>"; ?>
