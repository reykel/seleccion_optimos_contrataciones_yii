...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="clearfix"></div><br>
		<?php echo $form->label($model,'dependencia', array('class'=>'control-label')); ?>
			<?php echo $form->textField($model,'dependencia', array('class'=>'form-control', 'style'=>'font-size:11px;')); ?>
