...
<a class="btn btn-success btn-large" href="index.php?r=Aplicaciones/reporte"> 
	<i class="glyphicon glyphicon-print icon-white", title="Impresión de datos.", data-toggle="tooltip"></i>
</a>


<div  align="right">
        <a class="btn btn-info btn-large" href="index.php?r=Aplicaciones/create"> 
...
<?php 
	...
	'columns'=>array(
		array(
			'name'=>'instrumento_id',
			'type'=>'raw',
					'value'=>'CHtml::link(CHtml::encode($data->Instrumentos->instrumento), array("view&id=$data->id"))',
			),
					array(
			'name'=>'area_id',
			'type'=>'raw',
			'value'=>'$data->Areas->area',
		),
				'fecha',
		'coordinador',
	array(
