...
class CrugeStoredUser extends CActiveRecord implements ICrugeStoredUser
{
    ...
    public $newPasswordAgain; // declararlo 'safe'
    ...
    */
    ...
    {
        return array(
            array('username', 'match', 'pattern' => '/^[a-zA-Z0-9\_\-\.]{3,45}$/','message' => CrugeTranslator::t('logon', 'Invalid username')),
            ...
            array('newPasswordAgain', 'length', 'min' => 6, 'max' => 20),
            array('newPassword', 'match', 'pattern' => '/^[a-zA-Z0-9@#$%\_\-\.\*\%\&\$\#]{6,20}$/', 'message' => CrugeTranslator::t(
                    'logon',
                    'Password may contain numbers or symbols ({symbols}) and between {min} and {max} characters',
                    array('{symbols}' => '@#$%', '{min}' => 6, '{max}' => 20)
                )
            ),
            array('newPassword', 'compare', 'compareAttribute'=>'newPasswordAgain', 'on'=>'update, insert, manualcreate', 'message' =>'Ambas contraseñas deben coincidir completamente'),
