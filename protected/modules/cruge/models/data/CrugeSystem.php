    ...
    */
    ...
    public function rules()
    {
        ...
        return array(
            ...
            array('current_system_year', 'safe',),
            array('current_system_month', 'safe',),
            array('current_system_date', 'safe',),
            array('top_aspirantes_seleccionados', 'safe',),            
        );
    }
    ...
    public function attributeLabels()
    {
        return array(
            ...
            'current_system_year' => 'Año actual en el sistema',
            'current_system_month' => 'Mes actual en el sistema',
            'current_system_date' => 'Fecha actual en el sistema',
            'top_aspirantes_seleccionados'=>'Cantidad',
        );
    }
    ...
    public function get_current_year()
    {
        ...
        return $model->current_system_year;
    }

    public function get_current_month()
    {
        $model = CrugeSystem::model()->findByPk(1);
        return $model->current_system_month;
    }

    public function get_current_date()
    {
        $model = CrugeSystem::model()->findByPk(1);
        return $model->current_system_date;
    }

    public function get_top_aspirantes()
    {
        $model = CrugeSystem::model()->findByPk(1);
        if($model != null)
            return $model->top_aspirantes_seleccionados;
        else
            return 10;
    }
}
